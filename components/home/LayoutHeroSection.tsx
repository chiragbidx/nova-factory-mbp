    ...
    <section className="container w-full">
      <div className="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-20 md:py-32">
        <div className="text-center space-y-8">
          <Badge variant="outline" className="text-lg py-2 px-5 bg-primary/10 text-primary border-primary border-2">
            {hero.eyebrow}
          </Badge>
          <div className="max-w-screen-md mx-auto text-center text-4xl md:text-6xl font-bold">
            <h1>
              {hero.title.split(/(Marketiq)/g).map((part, idx) =>
                part === "Marketiq" ? (
                  <span
                    className="text-transparent px-2 bg-gradient-to-r from-violet-700 to-primary bg-clip-text"
                    key={idx}
                  >
                    {part}
                  </span>
